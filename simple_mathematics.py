...
print("Welcome to my Simple CLI calculator program")
...
while simple_cli_calculator:
    ...
    # validating operators
        ...
        print("Please, try again picking a proper operator. Invalid operator!")
...
print("Thanks for using my Simple CLI calculator program")
